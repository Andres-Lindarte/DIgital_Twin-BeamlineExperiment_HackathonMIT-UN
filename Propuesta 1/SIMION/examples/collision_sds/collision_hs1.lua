...
-- (c) 2006-2009 Scientific Instrument Services, Inc. (Licensed under SIMION 8.0)
...
-- Last known temperature (-1 = undefined).
local last_local_temperature_k = -1
-- Last known pressure (-1 = undefined).
local last_local_pressure_pa = -1
...
function segment.other_actions()
    ...
    if _mean_free_path_mm > 0 then -- explicitly specified
        ...
        if ion_number          ~= last_ion_number or
           local_temperature_k ~= last_local_temperature_k or
           local_pressure_pa   ~= last_local_pressure_pa or
        ...
        then
            ...
            last_local_temperature_k = local_temperature_k
            last_local_pressure_pa   = local_pressure_pa
