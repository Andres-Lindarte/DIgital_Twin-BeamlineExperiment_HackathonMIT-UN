...
--[[
 ...
 then a space-charge PA is created in memory (reusing it it already exists).
...
function M.add_charge_array(iinstance, chargepa)
  ...
  then
    error('Array size for charge density pa '..chargepa..' is inconsistent with array size for '..
          'potential array instance '..pa..' to Poisson solve.  For potential array size '..
