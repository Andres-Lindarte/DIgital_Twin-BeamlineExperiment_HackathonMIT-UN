;rf square wave mirror energy conservation test

defa  RF_voltage			80		;volts
...
seg initialize
	...
	message ;RF square wave conservation of energy test
...
seg fast_adjust
	...
	x<0 goto invert 		;convert to square wave
	rcl RF_voltage
	...
	lbl invert
	rcl RF_voltage
	sto adj_elect02 		;store as electrode 2
	chs
	sto adj_elect01 		;store -1 * value in electrode 1
	exit
...
seg other_actions
  ...
  lbl first_pass			;still looking for first peak
	...
	rcl RF_frequency 1/x 4 / entr * *
	2.41213271e12 * 		;d = peak to peak y estimate
							;d = 2.41213271e12 * rf_voltage * (t^2) /ion_mass
							;t = 1/(4 * rf_frequency)
