--[[
sphere_3dp.lua
Solves electric field due to dielectric sphere.
...
function segment.flym()
  ...
  print('E(center)_theo=',   E_0*3/(kinside/koutside + 2))
  print('E(center)_actual=', norm(painst:field_wc(50,0,0)))
end
