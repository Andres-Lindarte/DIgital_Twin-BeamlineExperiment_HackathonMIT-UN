...
defa _Mean_Free_Path           4.0    ; mean free path in mm
defa _Collision_Gas_Mass       4.0    ; assume helium
defa _Tickle_Voltage           0.0    ; tickle voltage
defa _Tickle_Frequency      544.0e3   ; tickle frequency of 544.0 khz
defa _Right_End_Cap_DC         0.0    ; right end cap voltage
defa _Qz_tune                  0.84   ; Qz tuning point
defa _Az_tune                  0.00   ; Az tuning point
defa _AMU_Mass_per_Charge     50.0    ; mass tune point in amu/unit charge
...
seg Other_Actions                   ; used to control pe surface updates
    ...
    rcl ion_mass rcl _collision_gas_mass + /    ; (m - 4)/(m + 4)
    rcl v * sto v                   ; attenuated velocity
    rcl el                          ;load up stack with polar velocity
    rcl az
    rcl v
    >r3d                            ;convert to rect3d
