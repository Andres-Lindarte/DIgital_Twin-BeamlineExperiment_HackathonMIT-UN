...
defa _Mean_Free_Path           1.0    ; mean free path in mm
...
defa _Target_Voltage          20.0    ; voltage of sims target
...
defa Random_Offset_mm           1.0   ; del start position (y,z) in mm
...
lbl skip1        
    rcl Ion_Px_mm                   ; get ion's x location
    11 x<y goto kill                ; kill if right of right limit
    goto skip                       ; do not kill ion
lbl kill
