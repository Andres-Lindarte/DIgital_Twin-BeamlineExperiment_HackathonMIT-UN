; ion trap demo program - demonstrates ion crystal formation
; David A. Dahl 1996
...
defa _Linear_Damping           0.0    ; adjustable variable for linear damping
...
defa Target_Voltage            0.0    ; voltage of sims target
defa Focus_Ring_Voltage       10.0    ; voltage on focus ring
...
seg Fast_Adjust                     ; generates trap rf with fast adjust
    ...
    rcl first x=0 gsb init          ; always init on first pass
    ...
    rcl Target_Voltage
    sto Adj_Elect04                 ; electrode 4 voltage - target voltage
    rcl Focus_Ring_Voltage
    ...
    chs 2 * sto Adj_Elect01         ; electrode 1 voltage - ring electrode
