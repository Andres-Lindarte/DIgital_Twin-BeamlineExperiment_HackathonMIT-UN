; ion trap demo program - demonstrates use of end cap tickle
; David A. Dahl 1995
...
defa _Tickle_Mass			  303.0   ; mass of Tickle ion
defa _Tickle_Voltage		   0.5	  ; tickle voltage
...
defs _qz_next				   0.0	  ; Tickle ion qz operating point
...
lbl init							; parameter initialization subroutine
	...
	rcl _Tickle_Mass /				; divide by Tickle ion mass
	sto _qz_next					; to get qz point of Tickle ion
	...
	rcl _qz_next					; qz to use for Tickle
...
lbl skip1							; don't change colors of non-tuned mass
	rcl ion_mass rcl _Tickle_Mass x!=y goto next
	rcl tickle
