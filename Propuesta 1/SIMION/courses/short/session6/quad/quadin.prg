...
defa Percent_Energy_Variation  10.0   ; (+- 10%) random energy variation at ion start
defa Cone_Angle_Off_Vel_Axis    5.0   ; (+- 5 deg) cone angle - spherical at ion start
defa Random_Offset_mm           0.1   ; random start position (y,z) offset in mm
defa Random_TOB            0.909091   ; random time of birth over one cycle
...
seg initialize      ; randomize ion's position, ke, and direction
        ...
        ;------------- el rotate back from 90 vertical -------------
        -90 >elr
