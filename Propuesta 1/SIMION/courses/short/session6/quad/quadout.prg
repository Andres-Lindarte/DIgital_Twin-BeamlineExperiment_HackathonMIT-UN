...
; David A. Dahl 1995, updated April 1996
...
defs Next_PE_Update_out        0.0    ; next time to update pe surface
...
seg Fast_Adjust                     ; generates quad rf with fast adjust
    ...
    rcl _Quad_Exit_Voltage
    sto Adj_elect03                 ; update quad exit voltage
 
    rcl _Detector_Voltage
    sto Adj_elect04                 ; update quad detector voltage
...
seg Other_Actions                   ; used to control pe surface updates
    rcl Next_PE_Update_out          ; recall time for next pe surface update
    ...
    + sto Next_PE_Update_out        ; add to tof and store as next pe update
